...
def get_mce_asce7(prob_mce, det_imt, DLLs, dstore):
    ...
    for i, imt in enumerate(det_imt):
        ...
        prob_mce_out[imt] = prob_mce[i]  # I think we should have the same number of IMTs 
        # everywhere as in the job.ini. For this first year we strat with 3 and then they'll become many later. 
